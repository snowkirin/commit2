...
const mypageStyle = () =>
  axios
    .get(`${API_URL}/member/mypage/style`, {
      withCredentials: true
    })
    .then(result => result)
    .catch(err => err.response);

const mypageTomorrowCloset = () =>
  axios
...
const mypageTomorrowSelect = ({ subscriptionId, products }) =>
  axios
    .put(
...
const mypageTomorrowSelectDirect = ({ subscriptionId, products, memberId }) =>
  axios
    .put(`${API_URL}/subscriptions/tomorrow/direct`, {
      subscription_id: subscriptionId,
      products,
      member_id: memberId
    })
...
const mypagePastClosetDetail = ({ pastId }) =>
  axios
    .get(`${API_URL}/subscriptions/past/${pastId}`, {
      withCredentials: true
    })
    .then(result => result)
    .catch(err => err.response);

const mypageCurrentCloset = () =>
  axios
...
const setChangeEmail = ({ changeEmail }) =>
  axios
    .patch(
...
const setChangePwd = ({ curPassword, newPassword }) =>
  axios
    .patch(
...
const authPhoneCheck = ({ authId, authNumber }) =>
  axios
    .patch(
      `${API_URL}/member/phone`,
      {
...
const buyUsedProduct = ({ amount, name, itemId, itemType, paymentMethod }) =>
  axios
    .post(
      `${API_URL}/payment/buyUsedProduct`,
      {
        amount,
        name,
        itemId,
