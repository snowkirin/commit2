  ...
  <div class="contents" :style="promotionStyle" ref="contents">
    ...
    <div v-else>
      ...
      <div class="contents-header">
        ...
        <p>
          (기한 내 미선택 시, 회원님께 더 어울릴 스타일로 자동 지정 후 배송
          됩니다.)
        </p>
      </div>
      <div class="content">
            ...
            >
              <div class="product-top">
                ...
                <p class="txt-styling-title">
                  {{ tomorrowData.productA.stylingTitle }}
                </p>
              </div>
              ...
              <div class="product-bot">
                <p class="txt-styling-tip">
                  {{ tomorrowData.productA.stylingTip }}
                </p>
              </div>
              <div class="btn-selected" v-if="isShowButton">
                <button
                  type="button"
          ...
          <div class="column">
            ...
            >
              <div class="product-top">
                ...
                <p class="txt-styling-title">
                  {{ tomorrowData.productB.stylingTitle }}
                </p>
              </div>
              <div class="product-mid">
                <div
              ...
              <div class="product-bot">
                <p class="txt-styling-tip">
                  {{ tomorrowData.productB.stylingTip }}
                </p>
              </div>
              <div class="btn-selected" v-if="isShowButton">
                <button
