<template>
  <div class="step1">
    ...
    <div class="desktop" v-else>
      ...
      <div class="footer">
        <!--<button class="txt-link" v-tooltip="questionTooltip">이용 중 상품 구매란?</button>-->
        <a href="#" class="txt-link" @click="showTooltip">이용 중 상품 구매란?</a>
        <button
          type="button"
          class="btn btn-primary h-50"
    ...
    <template v-if="tooltipToggle">
      <div class="tooltip" :style="tooltipStyle">
        ...
        <p class="tooltip-content">현재 고객님께서 이용 중인 옷을 반납하지 않고 소유하실 수 있도록 상품 금액을 결제하는 과정입니다. 상품 구매 가격은 이용 중인 상품의 상태에 따라 정상 구매 가격보다 할인된 가격으로 개별 책정되어 있습니다.</p>
