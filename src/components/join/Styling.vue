...
export default {
  ...
  methods: {
    ...
    selectStyle(data) {
      ...
      if (data === this.$const.STYLE_NATURAL)
        this.pickClassEvt(
          this.natural,
          this.unique,
          this.classic,
      ...
      else if (data === this.$const.STYLE_UNIQUE)
        this.pickClassEvt(
          this.unique,
          this.natural,
          this.modern,
      ...
      else if (data === this.$const.STYLE_MODERN)
        this.pickClassEvt(
          this.modern,
          this.unique,
          this.feminine,
      ...
      else if (data === this.$const.STYLE_CLASSIC)
        this.pickClassEvt(
          this.classic,
          this.natural,
          this.feminine,
      ...
      else if (data === this.$const.STYLE_FEMININE)
        this.pickClassEvt(
          this.feminine,
          this.classic,
          this.modern,
    ...
    changeCircleImage(main, obj) {
      ...
      if (window.outerWidth <= 486) {
        if (main === this.unique) {
          target.style.cssText =
            "display: block; width: 118%; height: 100%; top: 43%; left: 58.5%; background-size: 95%;";
          target.style.backgroundImage = `url(${require('@/assets/img/signup/hover_unique.png')})`;
        } else if (main === this.natural) {
          target.style.cssText =
            "display: block; width: 118%; height: 100%; top: 43%; left: 40.3%; background-size: 95%;";
          target.style.backgroundImage = `url(${require('@/assets/img/signup/hover_natural.png')})`;
        } else if (main === this.classic) {
          target.style.cssText =
            "display: block; width: 100%; height: 124%; top: 55%; left: 27.3%; background-size: 86%;";
          target.style.backgroundImage = `url(${require('@/assets/img/signup/hover_classic.png')})`;
        } else if (main === this.modern) {
          target.style.cssText =
            "display: block; width: 100%; height: 124%; top: 55%; left: 72%; background-size: 86%;";
          target.style.backgroundImage = `url(${require('@/assets/img/signup/hover_modern.png')})`;
        } else if (main === this.feminine) {
          target.style.cssText =
            "display: block; width: 138%; height: 100%; top: 93%; left: 50%; background-size: 95%;";
          target.style.backgroundImage = `url(${require('@/assets/img/signup/hover_feminine.png')})`;
        }
        return;
      }
      ...
      if (main === this.unique) {
        target.style.cssText =
          "display: block; width: 118%; height: 100%; top: 44%; left: 59.5%;";
        target.style.backgroundImage = `url(${require('@/assets/img/signup/hover_unique.png')})`;
      } else if (main === this.natural) {
        target.style.cssText =
          "display: block; width: 118%; height: 100%; top: 44%; left: 40.3%;";
        target.style.backgroundImage = `url(${require('@/assets/img/signup/hover_natural.png')})`;
      } else if (main === this.classic) {
        target.style.cssText =
        ...
        target.style.cssText =
          "display: block; width: 138%; height: 100%; top: 96%; left: 50%;";
        target.style.backgroundImage = `url(${require('@/assets/img/signup/hover_feminine.png')})`;
      }
    },
    pickClassEvt(main, sub1, sub2, outSub1, outSub2, imageTarget) {
      if (main) {
        ...
        main
          .querySelector("span.subject")
          .classList.add("zuly-detail-circle-pick-subject");
        ...
        outSub1
          .querySelector("span.description")
          .classList.add("zuly-circle-pick-none");
        outSub2
          .querySelector("span.description")
          .classList.add("zuly-circle-pick-none");
    ...
    removePick() {
      ...
      const circlePickDeactive = document.querySelectorAll(
        ".zuly-circle-pick-deactive"
      );

      if (circlePick.length > 0) {
        document
          .querySelector(".zuly-detail-circle-pick-subject")
          .classList.remove("zuly-detail-circle-pick-subject");
        document.querySelector(".circle-pick").style.display = "none";

        for (let i = 0; i < circlePick.length; i += 1) {
          circlePick[i].classList.remove(
            "zuly-detail-circle-pick",
            "zuly-circle-pick-second"
          );
        }
    ...
    circleHoverMobileEvt(main, sub1, sub2, outSub1, outSub2) {
      ...
      obj.onmouseclick = () => {
        ...
        obj
          .querySelector("span.subject")
          .classList.add("zuly-detail-circle-active-subject");
        obj.classList.add(
    ...
    circleHoverEvt(main, sub1, sub2, outSub1, outSub2) {
      ...
      obj.onmouseleave = () => {
        ...
        obj
          .querySelector("span.subject")
          .classList.remove("zuly-detail-circle-active-subject");
        obj.classList.remove(
          "zuly-main-circle-active",
          "zuly-detail-circle-active"
        );
        sub1.classList.remove(
          "zuly-detail-circle-active",
          "zuly-circle-active-second"
        );
        sub2.classList.remove(
          "zuly-detail-circle-active",
          "zuly-circle-active-second"
        );
        ...
        outObj1.querySelector("span.description").style.display =
          "inline-block";
        outObj2.querySelector("span.description").style.display =
          "inline-block";
    ...
    moveNext() {
      if (this.recentMood === null) {
        ...
        const formData = {
          mood: this.recentMood
        };
        this.setMood(formData);
